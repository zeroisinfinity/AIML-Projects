...
# 1. CONFIGURATION
# ==========================================
ASSET_FOLDER = "assets"  # Root folder to scan
MARKER_SIZE = 0.05  # 5cm
DICT_TO_USE = cv2.aruco.DICT_7X7_50
MODEL_SCALE = 0.15  # Default scale (Adjustable)
SMOOTHING = 0.6

# ==========================================
# 2. AUTO-SCANNER (Finds all your models)
# ==========================================
available_models = []
current_model_idx = 0
...
# ==========================================
# 3. UNIVERSAL LOADER (With Caching)
# ==========================================
model_list_id = None
...
def load_current_model():
    ...
    print(f"\n⬇️  Loading ({current_model_idx + 1}/{len(available_models)}): {os.path.basename(path)}")

    # Delete old list to free GPU memory
    ...
    try:
        ...
        if hasattr(mesh.visual, 'to_color'):
            try:
                ...
                pass  # Ignore baking errors for complex models
        ...
        for face in faces:
            for vertex_i in face:
                if colors is not None:
                    ...
                    glColor3f(0.8, 0.8, 0.8)  # Grey default
